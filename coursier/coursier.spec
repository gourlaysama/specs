...
Source0: https://github.com/coursier/coursier/archive/refs/tags/v2.1.0-M2-1.tar.gz
...
%prep
%setup -q -b0 -n coursier-2.1.0-M2-1
%patch0 -p1
...
%changelog
* Mon Dec 13 2021 Antoine Gourlay <antoine@gourlay.fr> - 2.1.0~M2.1-1
- coursier 2.1.0-M2-1
